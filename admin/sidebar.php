<div class="admin-section admin-section1">
    <ul>
        ...
        <li><i class="fas fa-ticket-alt"></i><a href="admin.php">Dashboard</a> </li>
        <li><i class="fas fa-ticket-alt"></i><a href="addmovie.php">Movies</a> </li>
        <li><i class="fas fa-ticket-alt"></i><a href="add.php">Theater and Show</a></li>
        <li><i class="fas fa-ticket-alt"></i><a href="user.php">User</a> </li>
    </ul>
</div>
